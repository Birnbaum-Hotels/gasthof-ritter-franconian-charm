            ...
            <Card className="overflow-hidden shadow-card hover:shadow-warm transition-shadow duration-300">
              <div className="relative h-64">
                ...
                <div className="absolute bottom-4 left-4 text-primary-foreground">
                  ...
                  <h3 className="text-2xl font-serif font-bold">Restaurant</h3>
                </div>
              </div>
              <CardContent className="p-6">
                <p className="text-muted-foreground mb-4">
                  Genießen Sie traditionelle fränkische Spezialitäten in gemütlicher Atmosphäre. 
                  Von hausgemachten Klößen bis zu regionalen Fleischgerichten.
                </p>
            ...
            <Card className="overflow-hidden shadow-card hover:shadow-warm transition-shadow duration-300">
              <div className="relative h-64">
                ...
                <div className="absolute bottom-4 left-4 text-primary-foreground">
                  ...
                  <h3 className="text-2xl font-serif font-bold">Hotel</h3>
                </div>
              </div>
              <CardContent className="p-6">
                <p className="text-muted-foreground mb-4">
                  15 gemütlich eingerichtete Zimmer mit modernem Komfort und traditionellem Charme. 
                  Perfekt für Ihren Aufenthalt in Franken.
                </p>
                <div className="flex gap-3">
