  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-96 flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-primary-foreground/90 max-w-2xl mx-auto">
            135+ Jahre fränkische Gastlichkeit - Eine Familientradition mit Herz und Geschichte
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Seit 1891 steht der Gasthof Ritter St. Georg für echte fränkische Gastlichkeit. Was als kleine
                Gaststätte begann, ist heute ein renommiertes Gasthaus mit Hotel, das von der Familie Ritter in dritter
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                <h3 className="text-2xl font-serif font-semibold text-primary mb-4">Tradition mit Herz</h3>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Johann Ritter gründete 1891 unseren Gasthof mit der Vision, Menschen aus nah und fern
                  zusammenzubringen und ihnen ein Stück fränkische Heimat zu bieten. Diese Philosophie leben wir noch
                  heute - mit authentischen Rezepten, regionalen Produkten und der herzlichen Art, die Franken so
                  besonders macht.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Über die Generationen hinweg haben wir uns stetig weiterentwickelt, ohne dabei unsere Wurzeln zu
                  vergessen. Heute vereinen wir traditionelle fränkische Küche mit modernem Komfort und zeitgemäßem
                  Service.
                </p>
              </div>
      ...
      <section className="py-16 bg-gradient-warm">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-serif font-bold text-primary mb-4">Die Familie Ritter</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
